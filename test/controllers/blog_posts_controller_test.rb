...
class BlogPostsControllerTest < ActionController::TestCase
  ...
  test "should create blog_post" do
    assert_difference('BlogPost.count') do
      post :create, blog_post: { content: @blog_post.content, publishdate: @blog_post.publishdate, title: @blog_post.title }
    end
  ...
  test "should update blog_post" do
    patch :update, id: @blog_post, blog_post: { content: @blog_post.content, publishdate: @blog_post.publishdate, title: @blog_post.title }
    assert_redirected_to blog_post_path(assigns(:blog_post))
  end
